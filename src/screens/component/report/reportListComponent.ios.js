...
export default class ReportListComponent extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            image:{uri : (props.reportdata.property) ? ((props.reportdata.property.optimized_img) ? props.reportdata.property.optimized_img : "http://notavailableimage" ) : "http://notavailableimage" },
