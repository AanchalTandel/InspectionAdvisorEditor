...
export default class ReportListComponent extends Component{
    ...
    onEdit = (reportId,organizationId,name) => {
        this.props.onEdit(reportId,organizationId,name)
    };

    onPreview = (selected,name) => {
        this.props.onPreview(selected,name)
    };
   ...
   onDelete = (selected) => {
    ...
    onPress  = (id,selected) => {
        this.props.onPress(id,selected)
    };
                            ...
                            <View style={{flex:1,justifyContent:'center'}}>
                                ...
                                <View style={{flexDirection:'row',flex:1}}>
                                    ...
                                    <View style={{width:30,flexDirection:'column',marginRight:10,justifyContent:'space-around'}}>
                                        ...
                                        <View style={{alignItems:'flex-end'}}>
                                            <TouchableHighlight underlayColor="transparent"
                                                                onPress={() => this.onPreview(this.state.data.id,this.state.data.name)}>
